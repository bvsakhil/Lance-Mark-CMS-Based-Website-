...
$result = $mysqli->query('SELECT * FROM wireframes ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                             <form action="searchinwire.php" method="GET"  class="form-inline my-2 my-lg-0">
...
<a  href="singlewire.php?id=<?php echo $row['id']?>" >
