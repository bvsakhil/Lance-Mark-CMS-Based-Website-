...
$QueryResult = @mysqli_query($DBConnect,
    ...
    "SELECT * FROM microinteractions
WHERE title LIKE '%$idofpost%' UNION SELECT * FROM apps
WHERE title LIKE '%$idofpost%'");

$QueryResult2 = @mysqli_query($DBConnect,

    "SELECT * FROM apps UNION SELECT * FROM microinteractions UNION SELECT * FROM websites UNION SELECT * FROM wireframes UNION SELECT * FROM landingpage ORDER BY timeofpost DESC ");
