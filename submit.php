...
<!--Image Block-->
             ...
             <div class="container">
                <div class="block-heading">
                    <h1 style="font-family: nextfontbold;">LANCE MARK</h1>
                   
                    <p style="font-family: nextfontreg;">Submit your work and get featured on our website.</p>
                </div>
               



<form style="font-family: nextfontreg;">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Drive Link">
    <small id="emailHelp" class="form-text text-muted">Upload your work in Google Drive, and submit the link here.</small>
  </div>
  
  <button type="submit" class="btn btn-primary"><i class="fas fa-file-upload"></i>Submit</button>
</form>
