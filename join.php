  ...
  line-height: 2em;box-shadow: 0 0 5px 0 rgba(0,0,0,.1) !important;" class="navbar navbar-expand-md ">
    ...
    &nbsp
            ...
            <li class="nav-item">
               ...
               <a href="join.php"> <button style="box-shadow: 0 0 5px 0 rgba(0,0,0,.1) !important;" type="button" class="btn btn-default btn-sm shadow-none">JOIN US</button></a>
            </li>
        </ul>
...
<!--Image Block-->
             ...
             <div  class="container">
                <div  class="block-heading">
                    <p style="font-family: nextfontreg;font-size:70px;">We're</p>
                   
                    <h1 style="font-family: nextfontbold;font-size:70px;">Growing !</h1>
...
<a style="font-family: nextfontreg;" href = "mailto:join@lancemarkstud.io">join@lancemarkstud.io</a>
                </div>
                <div class="col-md-6">
<p style="color:black;font-family: nextfontreg;">Join Our Community </p>
                </div>
               </div>
               </div>
