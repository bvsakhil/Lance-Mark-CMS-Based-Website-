...
$result = $mysqli->query('SELECT * FROM websites ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                               <form action="searchinweb.php" method="GET"  class="form-inline my-2 my-lg-0">
...
<a  href="singleweb.php?id=<?php echo $row['id']?>" >
