    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                <form action="searchinlandingpage.php" method="GET"  class="form-inline my-2 my-lg-0">

      <input id="myInput" style="background:#e6e6e6;border:none;color:848484;height:30px;" class="form-control mr-sm shadow-none" name="search" type="search" placeholder="Search" aria-label="Search">
...
<a  href="singlelandingpage.php?id=<?php echo $row['id']?>" >
