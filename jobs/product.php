...
require_once '../dashboard/processinproduct.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'job') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM productdesigner ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                <form action="searchinproduct.php" method="GET"  class="form-inline my-2 my-lg-0">
