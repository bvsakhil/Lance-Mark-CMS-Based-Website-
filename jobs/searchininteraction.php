...
require_once '../dashboard/processininteraction.php'; 


$DBConnect = @mysqli_connect("localhost", "root", "");

mysqli_select_db($DBConnect, "job");
...
$QueryResult2 = @mysqli_query($DBConnect,
    ...
    "SELECT logourl,title,role,location,applylink,dateofpost FROM interactiondesigner  WHERE title LIKE '%$idofpost%';");
...
<div  style="padding-top:20px;" class="container">
 <div  class="row">
  ...
  <div style="padding-left:30px;" class="col-sm-6">
       <img style="height:100px;width:100px;" src="<?php echo $Row2['logourl']; ?>" class="rounded float-left" alt="...">
  </div>

  <div class="col-sm-6">
       <h5 style="font-weight:bold;" class="card-title"><?php echo $Row2['title']; ?></h5>
       <p class="card-text"><?php echo $Row2['role']; ?></p>
  </div>
...
<hr>
  ...
  <div class="col-sm-4">
  <a href="<?php echo $Row2['applylink']; ?>" class="btn btn-primary btn-sm">Apply</a>
  </div>
