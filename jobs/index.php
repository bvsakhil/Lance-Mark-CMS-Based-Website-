...
require_once '../dashboard/processinart.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'job') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM artd UNION SELECT * FROM interactiondesigner UNION SELECT * FROM productdesigner UNION SELECT * FROM uidesigner UNION SELECT * FROM uxdesigner ORDER BY timeofpost DESC') or die($mysqli->error);
?>
...
<hr>
  ...
  <div class="col-sm-4">
             ...
             &nbsp&nbsp&nbsp&nbsp&nbsp <small class="card-text">3 days ago</small>
  ...
  <div class="col-sm-4">
  <a target="_blank" href="<?php echo $row['applylink']; ?>" class="btn btn-primary btn-sm">Apply</a>
  </div>
