...
require_once '../dashboard/processinux.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'job') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM uxdesigner ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                <form action="searchinux.php" method="GET"  class="form-inline my-2 my-lg-0">
...
<hr>
  ...
  <div class="col-sm-4">
              <small class="card-text"><i class="fas fa-map-marker-alt"></i>&nbsp<?php echo $row['location']; ?></small>
              <br>
