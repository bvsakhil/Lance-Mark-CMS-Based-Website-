...
require_once 'dashboard/process.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'portal') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM microinteractions ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                               <form action="searchinmicro.php" method="GET"  class="form-inline my-2 my-lg-0">
...
<a  href="singlemicro.php?id=<?php echo $row['id']?>" > 
