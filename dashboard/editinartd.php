...
<?php require_once 'processinart.php'; ?>

<?php 

$mysqli = new mysqli('localhost', 'root', '', 'job') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM artd') or die($mysqli->error);
...
while ($row = $result->fetch_assoc()): ?>
 ...
 <tr>
        ...
        <td>
<a href="postinartd.php?edit=<?php echo $row['id'];?>"><button id="edit" name="edit" type="button" class="btn btn-primary">Edit</button></a>
        </td>
        <td>
   <a href="processinart.php?delete=<?php echo $row['id'];?>">          <button id="delete" name="delete" type="button" class="btn btn-primary">Delete</button></a>
        </td>
      </tr>
