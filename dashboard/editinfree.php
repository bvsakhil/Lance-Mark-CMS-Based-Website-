        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Dashboard - Edit in Free (Choose the category)</h3>
</div>
...
<div class="container">
    ...
    <option target value="editinuikit.php
    ">Edit in UI Kits</option>
    <option value="editinfreelanding.php">Edit in LandingPage</option>
    <option value="editinicon.php">Edit in Icons</option>
    <option value="editinillustration.php">Edit in Illustrations</option>
    <option value="editinmockup.php">Edit in Mockup</option>
    <option value="editinpremium.php">Edit in Premium</option>
