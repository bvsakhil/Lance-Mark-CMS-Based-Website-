        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Dashboard - Edit in Jobs (Choose the category)</h3>
</div>
...
<div class="container">
    ...
    <option target value="editinuidesigner.php">Edit in UI Designer</option>
     <option value="editininteraction.php">Edit in Interaction Designer</option>
    <option value="editinproduct.php">Edit in Product Designer</option>
    <option value="editinuxd.php">Edit in UX Designer</option>
    <option value="editinartd.php">Edit in Art Director</option>
