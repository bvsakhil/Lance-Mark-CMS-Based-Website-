        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Dashboard - Edit in UI (Choose the category)</h3>
</div>
...
<div class="container">
    ...
    <option target value="editinapps.php
    ">Edit in Apps</option>
    <option value="editinmicro.php">Edit in MicroInteractions</option>
    <option value="editinweb.php">Edit in Websites</option>
    <option value="editinwire.php">Edit in Wireframes</option>
    <option value="editinlandingpage.php">Edit in Landingpages</option>
