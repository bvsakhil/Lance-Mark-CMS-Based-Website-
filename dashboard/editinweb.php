...
<?php require_once 'processinweb.php'; ?>

<?php 

$mysqli = new mysqli('localhost', 'root', '', 'portal') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM websites') or die($mysqli->error);
...
while ($row = $result->fetch_assoc()): ?>
 ...
 <tr>
        ...
        <td>
<a href="postinweb.php?edit=<?php echo $row['id'];?>"><button id="edit" name="edit" type="button" class="btn btn-primary">Edit</button></a>
        </td>
        <td>
   <a href="processinweb.php?delete=<?php echo $row['id'];?>">          <button id="delete" name="delete" type="button" class="btn btn-primary">Delete</button></a>
        </td>
      </tr>
