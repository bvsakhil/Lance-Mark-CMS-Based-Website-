...
require_once 'processinillustrations.php'; 


$mysqli = new mysqli('localhost', 'root', '', 'free') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM illustrations') or die($mysqli->error);

?>

<div class="row justify-content-center">
<form action="processinuikit.php" method="POST">
<input type="hidden" name="id" value="<?php echo $id; ?>">
  <div class="form-group">
    <label >Title</label>
    <input  name="title" type="text" value="<?php echo $title; ?>" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Title">
    
  </div>
  <div class="form-group">
    <label >Image URL</label>
    <input  name="url" type="text" value="<?php echo $url; ?>" class="form-control"  placeholder="Enter URL">
  </div>
  <div class="form-group">
    <label >Sketch Link</label>
    <input  name="link" type="text" value="<?php echo $link; ?>" class="form-control"  placeholder="Enter URL">
  </div>
  <div class="form-group">
    <label >Adobe XD Link</label>
    <input  name="xdlink" type="text" value="<?php echo $xdlink; ?>" class="form-control"  placeholder="Enter URL">
  </div>
  <div class="form-group">
    <label >Invision Studio Link</label>
    <input  name="invlink" type="text" value="<?php echo $invlink; ?>" class="form-control"  placeholder="Enter URL">
  </div>
