...
$result = $mysqli->query('SELECT * FROM uxdesigner') or die($mysqli->error);
...
while ($row = $result->fetch_assoc()): ?>
 ...
 <tr>
        ...
        <td>
<a href="postinuxd.php?edit=<?php echo $row['id'];?>"><button id="edit" name="edit" type="button" class="btn btn-primary">Edit</button></a>
        </td>
        <td>
   <a href="processinux.php?delete=<?php echo $row['id'];?>">          <button id="delete" name="delete" type="button" class="btn btn-primary">Delete</button></a>
        </td>
      </tr>
