  ...
  line-height: 2em;box-shadow: 0 0 5px 0 rgba(0,0,0,.1) !important;" class="navbar navbar-expand-md ">
    ...
    &nbsp
            ...
            <li class="nav-item">
               ...
               <a href="contests.php"> <button style="box-shadow: 0 0 5px 0 rgba(0,0,0,.1) !important;" type="button" class="btn btn-default btn-sm shadow-none">CONTESTS</button></a>
            </li>
            <li class="nav-item">
...
<!--Image Block-->
             ...
             <div class="container">
                <div class="block-heading">
                    <h1 style="font-family: nextfontbold;">LANCE MARK - CONTESTS</h1>
                    
                    <p style="font-family: nextfontreg;">Coming Soon</p>
                </div>
