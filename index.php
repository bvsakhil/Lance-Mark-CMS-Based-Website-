...
require_once 'dashboard/processinmicro.php';
require_once 'dashboard/processinweb.php'; 
require_once 'dashboard/processinwire.php'; 
require_once 'dashboard/processinlandingpage.php'; 
...
$result = $mysqli->query('SELECT * FROM apps UNION SELECT * FROM microinteractions UNION SELECT * FROM websites UNION SELECT * FROM wireframes UNION SELECT * FROM landingpage ORDER BY timeofpost DESC') or die($mysqli->error);
...
while ($row = $result->fetch_assoc()): ?>
 ...
 <a  id="imglink"  href="single.php?id=<?php echo $row['id']?>" > 
                        ...
                        <!--Image Heading Div-->
                         <div  id="textwrapper">
                            ...
                            <div  style=" font-family: nextfontreg;" id="imgtext"> <?php echo $row['title']; ?>
                            </div>
