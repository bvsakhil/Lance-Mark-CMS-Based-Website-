...
require_once '../dashboard/processinpremium.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'free') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM premium ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                 <form action="searchinpremium.php" method="GET"  class="form-inline my-2 my-lg-0">
...
<div  class="block-heading">
                   <h1  class="float-left" style="text-align:left;font-family:nextfontbold;color:white;"><span style="color:#f89406;">PREMIUM</span><br>HANDPICKED</h1>
                </div>
             </div>
...
<div style="margin-top:10px;margin-bottom:10px;" class="container">
  ...
  <a href="<?php echo $row['invlink']; ?>" target="_blank">
      <button style="background:#FF1B27;border:none;border-radius:15px;color:white;" type="button" class="btn  btn-sm">Invi Studio</button>
      </a>
  </div>
</div>
