...
$result = $mysqli->query('SELECT * FROM uikit UNION SELECT * FROM landingpage UNION SELECT * FROM icons UNION SELECT * FROM illustrations UNION SELECT * FROM mockup UNION SELECT * FROM premium ORDER BY timeofpost DESC') or die($mysqli->error);
...
.btn-sm{
  ...
  line-height: 2em;" class="navbar navbar-expand-md ">
    ...
    &nbsp
      ...
      <input style="background:#e6e6e6;border:none;color:848484;height:30px;" class="form-control mr-sm shadow-none" type="search" placeholder="Search" aria-label="Search">
...
<div style="margin-top:10px;margin-bottom:10px;" class="container">
  ...
  <a href="<?php echo $row['link']; ?>" target="_blank">
      <button style="background:#FFBA13;border:none;border-radius:15px;color:white;" type="button" class="btn  btn-sm">Sketch</button>
      </a>
  </div>
  <div class="col-sm-4">
  <a href="<?php echo $row['xdlink']; ?>" target="_blank">
      <button type="button" class="btn btn-sm" style="background:#FF1DCE;border:none;border-radius:15px;color:white;">Adobe XD</button>
      </a>
  </div>
  <div class="col-sm-4">
  <a href="<?php echo $row['invlink']; ?>" target="_blank">
      <button style="background:#FF1B27;border:none;border-radius:15px;color:white;" type="button" class="btn  btn-sm">Invision</button>
      </a>
  </div>
</div>
