...
$result = $mysqli->query('SELECT * FROM uikit ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
               <form action="searchinuikit.php" method="GET"  class="form-inline my-2 my-lg-0">
