...
require_once '../dashboard/processinillustrations.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'free') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM illustrations ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                <form action="searchinillustrations.php" method="GET"  class="form-inline my-2 my-lg-0">
