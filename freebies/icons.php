...
require_once '../dashboard/processinicons.php'; 



$mysqli = new mysqli('localhost', 'root', '', 'free') or die(mysqli_error($mysqli));
$result = $mysqli->query('SELECT * FROM icons ORDER BY timeofpost DESC') or die($mysqli->error);
?>
    ...
    &nbsp
        ...
        <ul class="nav navbar-nav navbar-right">
           ...
           <li>
            ...
            <li >
                <form action="searchinicons.php" method="GET"  class="form-inline my-2 my-lg-0">
